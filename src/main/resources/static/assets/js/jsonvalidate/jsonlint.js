/**
 * Created by xulinfan on 2017/8/11.
 */
                        ...
                        for (;;) {
                            ...
                            if (typeof t == "undefined" || !t.length || !t[0]) {
                                if (!k) {
                                    ...
                                    var B = "";
                                    this.lexer.showPosition ? B = "在第"+ (i + 1)+"行发生解析错误 "+ ":<br/>" + this.lexer.showPosition() + "<br/>此处缺少" + A.join(", ") + "字符, 实际上确是一个 '" + this.terminals_[q] + "'" : B = "在第"+ (i + 1)+"行发生解析错误 " + ": Unexpected " + (q == 1 ? "end of input" : "'" + (this.terminals_[q] || q) + "'"), this.parseError(B, {
